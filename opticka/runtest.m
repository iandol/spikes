...
stim.g(5)=gratingStimulus(struct('sf',1,'contrast',0.4,'color',[0.6 0.2 0.2 1],'tf',0.1,...
	'size',2,'xPosition',3,'yPosition',0,'gabor',0,'mask',0));

stim.g(6)=gratingStimulus(struct('sf',1,'contrast',0.5,'color',[0.6 0.4 0.4 0],'tf',1,...
	'driftDirection',-1,'size',2,'xPosition',5,'yPosition',5,'gabor',0,'mask',1));

stim.b(1)=barStimulus(struct('type','random','barWidth',1,'barLength',10,'speed',2,'xPosition',0,...
	'yPosition',0,'color',[1 1 1 1]));
