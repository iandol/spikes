...
%
% Author and Date:  Nikolay S. 29/03/2011. Last update:      Nikolay S. 29/03/2011.
%
...
if nargout==0
    subplot(m,n,p,varargin{:},'Units','Normalized','Position',[merged_left merged_bottom merged_width merged_height]);
else
    h=subplot(m,n,p,varargin{:},'Units','Normalized','Position',[merged_left merged_bottom merged_width merged_height]);
end