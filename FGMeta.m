	...
	%=======================================================================
		...
		function makeUI(obj)
			...
			handles.axistabs = uiextras.TabPanel('Parent', handles.hbox,'Padding',0,...
				'BackgroundColor',bgcolor,'TabSize',120,'SelectionChangedCallback',@obj.replot);
			...
			handles.controls3 = uiextras.Grid('Parent', handles.controls,'Padding',5,'Spacing',3,...
				'BackgroundColor',bgcolor);
...
% 				'String','Replot');
			...
			set(handles.controls,'Sizes', [30 -1 95]);
			set(handles.controls3,'ColumnSizes', [-1 -1 -1], 'RowSizes', [-1 -1 -1 -1])
