...
function DIComments_Callback(hObject, eventdata, handles)
% hObject    handle to DIComments (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of DIComments as text
%        str2double(get(hObject,'String')) returns contents of DIComments as a double
global data
